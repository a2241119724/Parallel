...
class MeshedDecoderLayer(Module):
    def __init__(self, d_model=GlobalConfig.d_model, d_k=64, d_v=64, h=8, d_ff=2048, dropout=.1, self_att_module=None,
...
class MeshedDecoder(Module):
    def __init__(self, vocab_size, max_len, N_dec, padding_idx, d_model=GlobalConfig.d_model, d_k=64, d_v=64, h=8, d_ff=2048, dropout=.1,
                 self_att_module=None, enc_att_module=None, self_att_module_kwargs=None, enc_att_module_kwargs=None, word_emb=None):
